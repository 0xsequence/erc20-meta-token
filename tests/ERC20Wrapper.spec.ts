...
import { ERC20Wrapper, ERC20Mock } from 'src/gen/typechain'
  ...
  context('When Erc20Wrapper contract is deployed', () => {
      ...
      describe('when depositing tokens', () => {
        ...
        context('When token contract is approved', () => {
          ...
          it('should REVERT if msg.value is not 0', async () => {
            const tx = userErc20WrapperContract.functions.deposit(tokenAddress, userAddress, depositAmount, {
              gasLimit: 1000000,
              value: 1
            })
    ...
    describe('onERC1155Received function', () => {
      ...
      describe('when withdrawing tokens', () => {
        ...
        it('should REVERT if user does not have sufficient wrapped tokens', async () => {
          const tx = userErc20WrapperContract.functions.safeTransferFrom(
            userAddress,
            wrapperAddress,
            tokenID,
            depositAmount.add(1),
    ...
    describe('onERC1155BatchReceived function', () => {
      ...
      describe('when withdrawing tokens', () => {
        ...
        it('should REVERT if user does not have sufficient wrapped tokens', async () => {
          //@ts-ignore
          const tx = userErc20WrapperContract.functions.safeBatchTransferFrom(
            userAddress,
            wrapperAddress,
            tokenIDs,
        ...
        context('When tokens are withdrawn', () => {
          beforeEach(async () => {
            //@ts-ignore
            await userErc20WrapperContract.functions.safeBatchTransferFrom(
              userAddress,
              wrapperAddress,
              tokenIDs,
              depositAmounts,
